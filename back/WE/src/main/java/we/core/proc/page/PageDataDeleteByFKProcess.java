 ...
 */
@Component
public class PageDataDeleteByFKProcess implements IProcess {
	...
	public Object execute(ProcessDto proceeDto, List<Object> resultList) throws Exception {
		...
		if (proceeDto.getObjData1() != null) {
			result += pageDataUpdateService.deleteDataByFKey(dataSourceInfo, columnInfoList,
					proceeDto.getObjData1(), keyIndex,
