 ...
 * @since 0.0
 */
@Service("userDepartmentPositionService")
public class UserDepartmentPositionServiceImpl extends BaseService implements UserGrantedAuthorityService {
	...
	public List<UserGrantedAuthorityModel> searchUserGrantedAuthority(UserInfoModel userInfo) {
		...
		// 用户部门信息一览取得
		tempList.addAll(userPositionDao.searchUserDepartmentPosition(userInfo));
