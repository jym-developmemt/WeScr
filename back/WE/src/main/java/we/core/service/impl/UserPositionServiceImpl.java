...
public class UserPositionServiceImpl extends BaseService implements UserGrantedAuthorityService {
	...
	public List<UserGrantedAuthorityModel> searchUserGrantedAuthority(UserInfoModel userInfo) {
		...
		// 用户职位信息一览取得
		tempList.addAll(userPositionDao.searchUserPosition(userInfo));
